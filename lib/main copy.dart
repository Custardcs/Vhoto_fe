...
class _MyAppState extends State<MyApp> {
  ...
  Row _buildStatusRow(IconData icon, String status, String number) {
    return Row(
      children: <Widget>[
        Icon(icon),
        Text(status),
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ListView(
                      children: <Widget>[
                        _buildStatusRow(Icons.check_circle, 'Safe', '888 888 888'),
                        _buildStatusRow(Icons.check_circle, 'Safe', '888 888 888'),
                        _buildStatusRow(Icons.error, 'Fail', '888 888 888'),
                        _buildStatusRow(Icons.error, 'Fail', '888 888 888'),
                      ],
                    ),
                    // Oval Shape
